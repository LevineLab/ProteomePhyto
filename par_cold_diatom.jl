...
# Parameters to simulate "cold-adapted diatom".
...
Td   = 25+273.0                  # K, critical high temperature
...
change_Ea = 0.65                 # eV, thermal dependency of metabolic reactions
change_ctag_max = 2e7            # maximum number of lipid molecules / um3, heat-mitigation capacity (alpha)
