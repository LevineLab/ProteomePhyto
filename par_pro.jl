...
# Parameters to simulate "Prochlorococcus".
...
K = Dict("tr" => 0.1, "ri" => 10^4, "lb" => 10^4, "p" => 50,
...
Mmax = 1e-5                      # unitless, maximum membrane transporter to lipid ratio
...
change_Ea = 0.85                 # eV, thermal dependency of metabolic reactions
change_ctag_max = 8e6            # maximum number of lipid molecules / um3, heat-mitigation capacity (alpha)
